...
def send_order_created(to: str, order, user_id: Optional[int] = None, pickup_or_delivery: str = "pickup", eta: str = "30 minutes"):
...
def send_order_status(to: str, order, status: str, eta: str = "15 minutes", user_id: Optional[int] = None):
...
def send_order_delivered(to: str, order, user_id: Optional[int] = None):
